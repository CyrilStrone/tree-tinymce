...
import { Root } from '@/stores/tree/interfaces';
import '../styles/tree-item.css';
import {
...
>((props, ref) => (
  ...
  >
    {/* {props.item.parentId !== undefined && (
      <div {...props.handleProps} className="TreeItem__Drag">
        <svg
    ...
    {props.item.children ? (
      props.item.children.length !== 0 ? (
        <div onClick={props.onCollapse} className="TreeItem__Collapse">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            height="1em"
            viewBox="0 0 448 512"
            style={{ transform: props.item.collapsed ? "rotate(180deg)" : "" }}
          >
    ...
    <div className="TreeItem__Title">{props.item.title}</div>
    <div className="TreeItem__Change">
      <svg
        xmlns="http://www.w3.org/2000/svg"
        height="1em"
        viewBox="0 0 512 512"
